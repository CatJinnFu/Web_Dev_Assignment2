...
// PURPOSE     : registration of user to website.
// SPECIAL NOTES:
// ===============================
// Change History:
//
    ...
    case 'register':
        ...
        if($_POST["firstname"] &&
           ...
           $_POST["email"]){
            ...
            $error = "You must enter values in all fields to register";
        }
                    ...
                    <div class="box">
                        ...
                        <form action="register.php?action=register" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email_test" name="email">
                            </div>
                            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <form action="register.php?action=login" method="post">
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="text" class="form-control" id="email_test_pw" name="email">
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" class="form-control" id="password" name="password">
