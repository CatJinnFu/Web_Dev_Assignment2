...
<!-- Page detail runs one function to load the item details buidlDetailPage().
     
-->

<body onload="loadXMLDoc('clothes.xml',buildDetailPage,'none','none');">
    <!-- *** TOPBAR ***
 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li id="men_list">
                                    <a href="category-man.php">Men <span class="badge pull-right"></span></a>
                                    <ul>
                                ...
                                <li id="lady_list">
                                    <a href="category-lady.php">Ladies  <span class="badge pull-right"></span></a>
                                    <ul>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row" id="productMain">
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                <h1 class="text-center" id='product'></h1>
                                <p class="goToDescription"><a href="#details" class="scroll-to">Scroll to product details, material & care and sizing</a>
                                </p>
                                <p class='price' id='aPrice'></p>

                                <p class="text-center buttons" id="cartbutton">
