    ...
    case 'login':
        if($_SESSION['password'] == $_POST["old"]){
            if($_POST["one"] == $_POST["two"]){ 
                $error = changePassword($_POST["one"]);
            } else {
               
                $error = "Password's dont match please re-enter and try again."; 
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9">
                    <div class="box">
                        ...
                        <form action="customer-account.php?action=login" method="post">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="password_old">Old password *</label>
                                        <input type="password" class="form-control" id="password_old" name="old">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password_1" name="one">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="password_2">Retype new password *</label>
                                        <input type="password" class="form-control" id="password_2" name="two">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="address" value="<?php echo $_SESSION['address']; ?>" name="address">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="company">Company</label>
                                        <input type="text" class="form-control" id="company" value="<?php echo $_SESSION['company']; ?>" name="company">
                                    </div>
                                </div>
                            </div>
                            <!-- /.row -->
    ...
    <option value="ZM">Zambia</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="email" value="<?php echo $_SESSION['emaildb']; ?>" name="email">
                                    </div>
                                </div>
