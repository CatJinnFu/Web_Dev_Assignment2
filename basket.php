        ...
        <div class="container">
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    <a href="basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm" id="items"></span></a>
                </div>
                <!--/.nav-collapse -->
                    ...
                    <div class="box">
                        ...
                        <form method="post" action="checkout1.php">
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="category_man.html" class="btn btn-default"><i class="fa fa-chevron-left"></i> Continue shopping</a>
                                </div>
